...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        setRemoveAnimation(holder, animation);// TODO ****************
        animation.setDuration(getRemoveDuration())
                .setListener(new VpaListenerAdapter() {
                    ...
                    public void onAnimationEnd(View view) {
                        ...
                        removeAnimationEnd(holder);// TODO ****************
    ...
    void animateAddImpl(final ViewHolder holder) {
        ...
        setAddAnimation(holder, animation);// TODO ****************
        animation.setDuration(getAddDuration()).
                setListener(new VpaListenerAdapter() {
                    ...
                    public void onAnimationCancel(View view) {
                        addAnimationCancel(holder);// TODO ****************
                    }
    ...
    public boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder,
        ...
        if (newHolder != null) {
            ...
            newChangeAnimationInit(newHolder);// TODO ****************
        }
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            setOldChangeAnimation(holder, oldViewAnim);// TODO ****************
            oldViewAnim.setListener(new VpaListenerAdapter() {
                ...
                public void onAnimationEnd(View view) {
                    ...
                    oldChangeAnimationEnd(holder);// TODO ****************
                    ViewCompat.setTranslationX(view, 0);
                    ViewCompat.setTranslationY(view, 0);
        ...
        if (newView != null) {
            ...
            setNewChangeAnimation(newHolder, newViewAnimation);// TODO ****************
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration()).
                    setListener(new VpaListenerAdapter() {
                        ...
                        public void onAnimationEnd(View view) {
                            ...
                            newChangeAnimationEnd(newHolder);// TODO ****************
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder item) {
        ...
        newChangeAnimationEnd(item);// TODO **************************************
    ...
    public void endAnimation(ViewHolder item) {
        ...
        if (mPendingRemovals.remove(item)) {
            removeAnimationEnd(item); // TODO ******
            dispatchRemoveFinished(item);
        }
        if (mPendingAdditions.remove(item)) {
            addAnimationCancel(item); // TODO ******
