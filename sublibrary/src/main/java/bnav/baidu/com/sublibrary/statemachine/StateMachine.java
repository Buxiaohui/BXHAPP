package bnav.baidu.com.sublibrary.statemachine;
...
public class StateMachine {
    ...
    private static class SmHandler extends Handler {
        ...
        public final void handleMessage(Message msg) {
            LogUtil.e("StateMachine", "handleMessage msg.what:" + msg.what);
            if (!mHasQuit) {
        ...
        private final void moveDeferredMessageAtFrontOfQueue() {
            ...
            for (int i = mDeferredMessages.size() - 1; i >= 0; i--) {
                ...
                if (mDbg) {
                    mSm.log("moveDeferredMessageAtFrontOfQueue; what=" + curMsg.what);
                }
        ...
        private void removeState(State state) {
            ...
            for (int i = 0; i < mStateInfo.values().size(); i++) {
                StateInfo info = mStateInfo.get(i);
                if (info != null && info.parentStateInfo == stateInfo) {
                    isParent = true;
                    break;
                }
            }
            /** new-end **/
            Log.e("StateMachine", "removeState,isParent:" + isParent);
